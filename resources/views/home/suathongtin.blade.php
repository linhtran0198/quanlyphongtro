...
<div class="container">
	<div class="row">
		<div class="col">
			<h2 class="title-comm"><span class="title-holder">SỬA THÔNG TIN PHÒNG TRỌ</span></h2>
          ...
          @if(Auth::user()->tinhtrang != 0)
					<form action="user/suaphongtro/{{$motelroom->id}}" method="POST" enctype="multipart/form-data" >
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
						<div class="form-group">
							<label for="usr">Tiêu đề bài đăng:</label>
							<input type="text" class="form-control" value="{{$motelroom->title}}" name="txttitle">
						</div>
						<div class="form-group">
              ...
              <input type="hidden" id="txtaddress" name="txtaddress" value="{{$motelroom->address}}"  class="form-control"  />
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" name="txtprice" class="form-control" value="{{$motelroom->price}}" >
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="usr">Diện tích( m<sup>2</sup> ):</label>
                  <input type="number" name="txtarea" class="form-control" value="{{$motelroom->area}}">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="txtphone" class="form-control" value="{{$motelroom->phone}}">
                </div>
              </div>
            </div> 
            <div class="form-group">
              ...
              <select id="select-state" name="tienich[]" multiple class="demo-default" value="{{$motelroom->utilities}}">
            ...
            <button class="btn btn-primary"></a>Sửa bài</button>
          </form>
          @else
          <div class="alert bg-danger">
            <button type="button" class="close" data-dismiss="alert"><span>×</span><span class="sr-only">Close</span></button>
